...
*/
public class MorepacksDao extends AbstractDao<Morepacks, Integer> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected Integer updateKeyAfterInsert(Morepacks entity, long rowId) {
        return entity.getId();
    }
    
    /** @inheritdoc */
    @Override
    public Integer getKey(Morepacks entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
