...
public class HackAppWorkUtil {

    public static final String TAG = HackAppWorkUtil.class.getSimpleName();
               ...
               // }
                ...
                try {
                 ...
                 try {
                        ...
                        //paramContacts.put("appVersion", String.valueOf(bobblePrefs.appVersion().get()));
                        //paramContacts.put("sdkVersion", Build.VERSION.RELEASE);
                        //paramContacts.put("deviceType", BobbleConstants.DEVICE_TYPE);
